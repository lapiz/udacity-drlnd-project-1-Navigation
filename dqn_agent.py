...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, params):
        ...
        # Q-Network
        self.qnetwork_local = QNetwork(state_size, action_size, seed, params['hidden_layer']).to(device)
        self.qnetwork_target = QNetwork(state_size, action_size, seed, params['hidden_layer']).to(device)
        self.optimizer = optim.Adam(self.qnetwork_local.parameters(), lr=params['LR'])

        # Replay memory
        self.memory = ReplayBuffer(action_size, params['buffer_size'], self.batch_size, seed)
    ...
    def Load(self, fn):
        self.qnetwork_local.load_state_dict(torch.load(fn))
